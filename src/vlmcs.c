...
#		endif // USE_MSRPC
		...
		"<port>:\t\tTCP port name of the KMS to use. Default 1700.\n"
...
{
	printf(
		"\nRequest activation for Office 2013 using V4 protocol from 192.168.1.5:1700\n"
		"\t%s -l \"Office 2013 Professional\" -4 192.168.1.5\n"
		"\t%s -l \"Office 2013 Professional\" -4 192.168.1.5:1700\n\n"

		"Request activation for Windows Server 2012 using V4 protocol from localhost:1700\n"
		"\t%s -4 -l \"Windows Server 2012\" -k 8665cb71-468c-4aa3-a337-cb9bc9d5eaac\n"
		"\t%s -4 -l \"Windows Server 2012\"\n"
		"\t%s -4 -l \"Windows Server 2012\" [::1]:1700\n"
		"\t%s -4 -l \"Windows Server 2012\" 127.0.0.2:1700\n\n"

		"Send 100,000 requests to localhost:1700\n"
		"\t%s -n 100000\n\n"
